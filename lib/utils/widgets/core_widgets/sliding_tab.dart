...
class ActivSlidingTab extends StatefulWidget {
  const ActivSlidingTab({
  ...
  @override
  State<ActivSlidingTab> createState() => _ActivSlidingTabState();
}

class _ActivSlidingTabState extends State<ActivSlidingTab> {
