              ...
              child: Column(
                ...
                children: [
                  DropdownTextField(
                    ...
                    options: Sports.values.map((e) => e.name).toList(),
                  ),
                          ...
                          ActivChip(
                            ...
                            onTap: () {
                              if (state.levels.contains('Beginner')) {
                                ...
                                context.read<HomeCubit>().addLevel('Beginner');
                              }
                            },
                          ),
                          ActivChip(
                            text: 'Intermediate',
                            isSelected: state.levels.contains('Intermediate'),
                            onTap: () {
                      ...
                      return Column(
                        ...
                        children: [
                          ActivButton(
                            ...
                            borderColor: AppColors.activeDetailsProgressBar,
                            ...
                            onPressed: state.selectedLocation.isNotNull
                                ? null
                                : () {
                                    context.read<HomeCubit>().pickLocation();
                                  },
                          ),
